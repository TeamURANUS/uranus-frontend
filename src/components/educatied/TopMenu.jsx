...
class TopMenu extends Component {
    ...
    render() {
        return (
            <div className="w-full flex items-center fixed bg-white max-h-[4rem] h-[4rem] drop-shadow-xl">
                ...
                <div className=" flex justify-end items-center basis-1/4 mr-5">
                    <Dropdown overlay={this.menu} trigger={['click']}>
                        <span className="select-none flex items-center text-black" onClick={e => e.preventDefault()}>
                            <Avatar size={40} src={"https://joeschmoe.io/api/v1/16" + this.props.user.id}/>
